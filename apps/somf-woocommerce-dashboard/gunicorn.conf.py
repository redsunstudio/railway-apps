...
def post_worker_init(worker):
    ...
    # Note: Background refresh from gunicorn was causing threading issues.
    # SQLite persistence handles fast startup - first request after deploy fetches fresh data.
